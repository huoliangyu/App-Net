...
class TcPRIOCeil(Tc):
    ...
    def addClass(self, parent, classid, rate, ceil):
        # add three classes
        if self.burst:
            cmd = "tc class add dev %s parent %s classid %s htb rate %s ceil %s burst %s" \
                    % (self.interface, \
                    parent, \
                    classid, \
                    rate, \
            ...
            cmd = "tc class add dev %s parent %s classid %s htb rate %s ceil %s" \
                    % (self.interface, \
                    parent, \
                    classid, \
                    rate, \
