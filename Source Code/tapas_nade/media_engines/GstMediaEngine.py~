...
demux.
    ...
    DEC_VIDEO_H264 = '''ffdec_h264 ! timeoverlay ! textoverlay text="kerogerop" ! videorate ! videoscale ! video/x-raw-yuv,width=1280,height=720,framerate=30/1 ! xvimagesink qos=0'''
